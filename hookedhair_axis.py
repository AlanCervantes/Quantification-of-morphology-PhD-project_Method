## Quantify the degree of 'hooking' in a hooked hair ##
...
## make skeleton ##
img=cv2.imread(r"/Users/ankita/Desktop/Data/hookedhair_commonbean.png",0)

def disthistogram(img):
...
dis,skeletonCoordsX,skeletonCoordsY,choppedX,choppedY,fitX,fitY,x_new,y_new,Cx,Cy,orangePointY,orangePointX,Skelmidy,Skelmidy1=disthistogram(img)
mu, std = norm.fit(dis) 
