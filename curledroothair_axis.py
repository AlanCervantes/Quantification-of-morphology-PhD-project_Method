#This script was used to quantify the degree of hooking in a curled root hair#
...
## make skeleton ##
img=cv2.imread(r"/Users/ankita/Desktop/Data/Hooking_images/curledroothair_commonbean.png",0)

def disthistogramR(img):
    ...
    # ## clean skeleton ##
    chopped=chopskel(skeletonCoordsX,orangePointX,skeletonCoords)
    ...
    # get fit line ##
    listx=[i for i in choppedY if i > Skelmidy1]   
        #print(listy)     
        # make list
    fit=[]
    for i in  listx:
    ...
    return (dis,skeletonCoordsX,skeletonCoordsY,choppedX,choppedY,fitX,fitY,Cx,Cy,x_new,y_new,orangePointX,orangePointY,Skelmidy,Skelmidy1)
    
dis,skeletonCoordsX,skeletonCoordsY,choppedX,choppedY,fitX,fitY,Cx,Cy,x_new,y_new,orangePointX,orangePointY,Skelmidy,Skelmidy1=disthistogramR(img)
