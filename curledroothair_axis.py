...
## make skeleton ##
img=cv2.imread(r"/Users/ankita/Desktop/Data/curledroothair_commonbean.png",0)

def dishistogram(img):
...
dis,skeletonCoordsX,skeletonCoordsY,choppedX,choppedY,fitX,fitY,Cx,Cy,x_new,y_new,orangePointX,orangePointY,Skelmidy,Skelmidy1=dishistogram(img)
