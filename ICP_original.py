...
path1 = "path to the location of file of data contour coordinates in ICP implementation"
path2 = "path to the location of file of model contour coordinates in ICP implementation"
path3 = "path to the location of file of superimposed data coordinates in ICP implementation"
path4 = "path to the location of file of the rotation matrix implemented in ICP"
path5 = "path to the location of file of the translation matrix implemented in ICP"
...
class ICP(object):
    ...
    def icp(self):
        ...
        while 1:
            ...
            # with open(r"C:\Users\ar54482\Desktop\Data\Main_data\L88-57\Final Analysis\Geometric Morphometrics\NS\Shape Analysis\superimposedcoordinates.txt", 'wb') as filehandle:
            #     simplejson.dump(data_transformed_new,filehandle)
            f=open(path3, 'w') 
