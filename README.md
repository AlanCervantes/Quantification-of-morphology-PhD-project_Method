...
2. To calculate area and peremeter of extracted hooked hair run 'python3 Perimeter+CS.py DataAnalysis/RGB DataAnalysis/', * python3 Perimeter+CS.py input-path output-path DataAnalysis/RGB* should be the output directory from step 1*  
3. To analyse how the area and peremeter change with age and growth of the plant run 'python3 Data_Analysis_AP.py DataAnalysis/' *python3 Data_Analysis_AP.py input-path the input path is the output path from step 2' 
