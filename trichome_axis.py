...
## All functions here ##
img=cv2.imread(r"/Users/ankita/Desktop/Data/trichome_commonbean.png",0)
...
dis,skeletonCoordsX,skeletonCoordsY,choppedX,choppedY,fitX,fitY,x_new,y_new,Cx,Cy,orangePointY,orangePointX,mp=disthistogram(img)
